hex_map = {
    "J": "0", "2": "1", "3": "2", "4": "3", "5": "4", "6": "5", "7": "6", "8": "7", "9": "8", "T": "9", "Q": "A", "K": "B", "A": "C"
}
...
def rank_hand(item):
    ...
    j = composition["J"]
    composition.pop("J")
    # Get the card with the most occurrences, and make the jokers into that card.
    composition[sorted(composition.items(), key=lambda x: x[1], reverse=True)[0][0]] += j
    # 5 of a kind
